import com.concrete.prj.login.security.CScJwtTokenResolver;
...
public class CCAuthTest {
    ...
    public void signUpTestSetup() {
        ...
        signUpURI = "http://localhost:8080/loginapp/signup.json";
        loginURI = "http://localhost:8080/loginapp/login.json";
        userProfileURI = "http://localhost:8080/loginapp/users";
    ...
    public void testValidUserProfile() {
        ...
        headers.set("Authorization", "Bearer " + signedUpUser.getToken().getAccessToken());
        ...
        Assert.assertEquals(signedUpUser.getToken().getAccessToken(), Objects.requireNonNull(registeredUser.getBody()).getToken().getAccessToken());
    }
