...
import com.concrete.prj.login.exception.response.CScApiError;
import com.concrete.prj.login.exception.response.CSxHttpException;
import com.concrete.prj.login.exception.response.CSxRequestAuthenticationException;
import com.concrete.prj.login.exception.response.CSxRequestInternalErrorException;
...
public class CScResponseErrorBuilder {
     ...
     */
    public void buildResponseJson(RuntimeException aEx) {
